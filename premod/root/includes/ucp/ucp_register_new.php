...
class ucp_register
{
	...
	function main($id, $mode)
	{
		...
		if ($submit)
		{
			...
			if($xmlStr['ip']['frequency'] >= "5" || $xmlStr['email']['frequency'] >= "5") {
			$error[] = "We're Sorry! But the email address provided is not allowed. Or your IP address is blacklisted. Please contact an administrator if this is in error.";
