	...
	function module()
	{
		return array(
			...
			'modes'		=> array(
				...
				'country_flag'			=> array('title' => 'ACP_FLAG_SETTINGS', 'auth' => 'acl_a_board', 'cat' => array('ACP_BOARD_CONFIGURATION')),
				// Country Flags Version 3.0.6
		
				// Friend list on member view by DaMysterious
				'profilefriends'	=> array('title' => 'ACP_PROFILE_FRIENDS', 'auth' => 'acl_a_board', 'cat' => array('ACP_FRIEND_SETTINGS')),
				// Friend list on member view by DaMysterious
