...
class user extends session
{
	...
	*/
	function setup($lang_set = false, $style = 12)
	{
		...
		$stylewere = is_numeric($style)  ? "s.style_id = $style" : "s.style_name = $style";
		$sql = 'SELECT s.style_id, s.style_name, t.template_storedb, t.template_path, t.template_id, t.bbcode_bitfield, t.template_inherits_id, t.template_inherit_path, c.theme_path, c.theme_name, c.theme_storedb, c.theme_id, i.imageset_path, i.imageset_id, i.imageset_name
