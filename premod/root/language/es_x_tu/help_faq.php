...
$help = array(
	...
	array(
		...
		1	=> 'Los emoticonos son pequeñas imagenes que pueden ser utilizadas para expresar un sentimiento con un pequeño código, e.j. :) denota felicidad, mientras que :( denota tristeza. La lista completa de emoticones puede verse en el formulario de publicación. Trata de no abusar del uso de emoticonos, pues pueden hacer que un mensaje se vuelva muy díficil de leer y un moderador remueva el tema o los emoticones del mensaje. La administración puede fijar un límite para el número de emoticones a utilizarse en un mensaje.',
	),
	array(
	...
	array(
		...
		1	=> ' Si eres miembro de más de un grupo tu grupo por omisión se usa para determinar que color y rango se mostrara por omision. La administración del Sitio debe darte permisos para cambiar tu grupo por omision mediante tu Panel de Control de Usuario.',
	),
	array(
	...
	array(
		...
		1	=> 'Hay tres razones posibles; no estás registrado y/o no identificado, la administración del foro ha desabilitado la opción de mensajes privados para todos los usuarios, ó la administración ha deshabilidato para ti la opción de enviar mensajes. Comunícate con La Administración para más información.',
	),
	array(
	...
	array(
		...
		1	=> 'Puedes utilizar la lista para organizar otros usuarios del foro. Los usuarios añadidos a su lista de Amigos podrán verse en en Panel de Control de Usuario para un rápido acceso a ver si están identificados y poder así enviarles un mensaje privado. Según la plantilla que utilice el foro, los mensajes de estos usuarios pueden visualizarse resaltados. Si añades un usuario a su lista de Ignorados, todos sus mensajes serán ocultados.',
	),
	array(
	...
	array(
		...
		1	=> 'Ingresando un término de búsqueda en el campo correspondiente del buscardor del index, foro ó en los temas. Puedes acceder a búsquedas avanzadas haciendo clic en el enlace "Busqueda Avanzada" que está disponible en todas las páginas del foro. La manera de acceder a la búsqueda depende del estilo utilizado.',
	),
	array(
	...
	array(
		...
		1	=> 'Para suscribirte a un foro en especial, debes hacer clic en el enlace "Suscribir Foro". Para suscribirte a un tema, debes activar la casilla "Subscribir" cuando envías una respuesta al mismo o hacer clic en el enlace "Subscribir tema".',
	),
	array(
	...
	array(
		...
		1   => 'Este foro fue escrito y licenciado a través de phpBB Group. Si crees que se debe añadir alguna característica, o si deseas informar de un error, por favor visita el sitio web <a phpBB href="http://area51.phpbb.com/">Area51</a>, donde encontrarás recursos para poder hacerlo.',
	),
	array(
