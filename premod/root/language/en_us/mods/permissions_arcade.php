...
*
* @package language
* @version $Id: permissions_arcade.php 1663 2011-09-22 12:09:30Z killbill $
...
// Admin Permissions
$lang = array_merge($lang, array(
	'acl_a_arcade'					=> array('lang' => 'Can manage arcade reset',				'cat' => 'arcade'),
	...
	'acl_a_arcade_points_settings'	=> array('lang' => 'Can manage arcade points settings',		'cat' => 'arcade'),
	...
	'acl_a_arcade_backup'			=> array('lang' => 'Can backup arcade categories.', 		'cat' => 'arcade'),
));

$lang = array_merge($lang, array(
	'acl_u_arcade'					=> array('lang' => 'Can use the arcade',					'cat' => 'arcade'),
	'acl_u_favorites'				=> array('lang' => 'Can add/remove favorite games',			'cat' => 'arcade'),
	'acl_u_ignoreflood_search'		=> array('lang' => 'Can ignore search flood limit',			'cat' => 'arcade'),
	'acl_u_view_whoisplaying'		=> array('lang' => 'Can view who is playing games',			'cat' => 'arcade'),
	'acl_u_viewstats'				=> array('lang' => 'Can view stats page',					'cat' => 'arcade'),
));
...
$lang = array_merge($lang, array(
	...
	'acl_c_re_rate'					=> array('lang' => 'Can change own ratings',				'cat' => 'arcade'),
	...
	'acl_c_ignoreflood_download'	=> array('lang' => 'Can ignore download flood limit',		'cat' => 'arcade'),
	'acl_c_ignoreflood_play'		=> array('lang' => 'Can ignore play flood limit',			'cat' => 'arcade'),
));
