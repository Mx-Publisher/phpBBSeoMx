...
$lang = array_merge($lang, array(
	...
	'GROUP_MEMBERS_EXPLAIN'			=> 'זוהי הרשימה המלאה של כל המשתמשים החברים בקבוצה זו. כולל רווחים לזיהוי הראשיים, הממתינים והחברים הקיימים. מפה אתה יכול לערוך הכל. בכדי להסיר ראשי אך להשאיר את החברים בקבוצה השתמש בהדחה ולאחר מכן מחק. וההפך השתמש בקידום בכדי להפוך משתמש קיים לראשי קבוצה.',
